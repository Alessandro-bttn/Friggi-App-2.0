...
import '../../../Dipendenti/widgets/dipendente_form.dart';
    ...
    return SearchAnchor(
      ...
      viewTrailing: [
        IconButton(
          ...
          onPressed: () async {
            final bool? aggiunto = await showModalBottomSheet<bool>(
              context: context,
              isScrollControlled: true,
              builder: (context) => const DipendenteForm(),
            );

            if (aggiunto == true && mounted) {
      ...
      suggestionsBuilder: (BuildContext context, SearchController controller) {
        ...
        // Filtriamo la lista aggiornata in tempo reale
